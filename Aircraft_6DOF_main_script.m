...
params.thetea0 = 0.034; %Estimated initial Euler angle pitch angle in rad.
...
params.CnR = -0.1394;
params.CnP = -0.0244;
controls.delta_e_gain1 = 0;
controls.delta_e_gain2 = 0;
...
%end
 ...
 flightParameters(ind,:) = [t elevator(ind) rudder(ind) aileron(ind) ipl(1:6) AOA(ind) sideSlip(ind) ipl(10:12)];
 disp(monitor);
end
